  ...
  return (
    <div className="bg-color-black mg-5 flex justify-center items-center h-screen">
      <Space direction="vertical">
        <h1 className="text-center decoration-clone pb-3 text-6xl bg-clip-text text-transparent bg-gradient-to-r from-orca-blue to-orca-pink">
        ...
        <Button className="justify-center w-full" onClick={onClick}>
          login
        </Button>
      </Space>
    </div>
